...
global.mess = {
  ...
  botadmin:
    "Tut mir leid, ich kann diesen Befehl nicht ausführen, ohne ein *Admin* zu sein.",
  botowner: "Sorry nur der *Owner* Kann diesen Command benutzen!",
  grouponly: "Dieser Befehl ist nur für *Gruppe* Gemacht!",
  privateonly: "Dieser Befehl ist nur für *Private Chat* Nutzbar!",
  ...
  nonsfw: "Sei nicht so Versaut du Schlingel der NSFW ist nicht Aktiv in der Gruppe!",
};
